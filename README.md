...
<div align="center">
  ...
  <h3><b>Random Greetings API</b></h3>
...
# 📖 Random Greetings API <a name="about-project"></a>

**Random Greetings API** is an API application that provides a random greeting from a collection of greetings.
...
- **Provides a random greeting from the collection**
...
```sh
  git clone https://github.com/MAleemH/hello-rails-back-end.git
```
...
[![GitHub Repo](https://img.shields.io/github/stars/MAleemH/hello-rails-back-end.svg?style=social)](https://github.com/MAleemH/hello-rails-back-end.git)
